...
container_div.classList.add('grid-container');
...
board_number_container_div.classList.add('item2');
// game_body_div.append(congratulationsDiv, statsDiv, board_number_container_div);

//Appenders
container_div.append(headerDiv, statsDiv, board_number_container_div);
outerDiv.append(titleDiv, container_div);
...
function createHeaderDiv() {
    ...
    headerDiv.id='header';
    headerDiv.classList.add('headerDiv', 'item1');
