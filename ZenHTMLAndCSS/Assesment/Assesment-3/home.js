...
function createNavBar(){
    ...
    //     </button>
    let navToggleButton = document.createElement('button');
    navToggleButton.setAttribute('type', 'button');
    
    navToggleButton.setAttribute('class', 'navbar-toggler');
    navToggleButton.setAttribute('data-toggle', 'collapse');
    navToggleButton.setAttribute('data-target', '#navbarNav');
    //navToggleButton.setAttribute('aria-expanded', 'false');

    let span = document.createElement('span');
    span.setAttribute('class', 'navbar-toggler-icon');
    navToggleButton.append(span);
    ...
    allSectionDiv.setAttribute('class', 'collapse navbar-collapse justify-content-between');
    ...
    navBar.append(navToggleButton, allSectionDiv);
    ...
    // navBar.setAttribute('id', 'navbar-primary');
    // navBar.setAttribute('role', 'navigation');
    // let allSectionDiv = document.createElement('div');
    // allSectionDiv.setAttribute('class', 'container');
    // let navbarHeader = document.createElement('div');
    // navbarHeader.setAttribute('class', 'navbar-header');
    // let navToggleButton = document.createElement('button');
    // navToggleButton.setAttribute('type', 'button');
    // navToggleButton.setAttribute('class', 'navbar-toggle-collapsed')
    // navToggleButton.setAttribute('data-toggle', 'collapse');
    // navToggleButton.setAttribute('data-target', '#navbar-primary-collapse');
    // navToggleButton.setAttribute('aria-expanded', 'false');
    ...
    // navToggleButton.append(span1, span2, span3, span4);
    // navbarHeader.appendChild(navToggleButton);

    // let navDiv = document.createElement('div');
    // navDiv.setAttribute('class', 'navbar-collapse collapse');
    // navDiv.setAttribute('id', 'navbar-primary-collapse');
    // let list = document.createElement('ul');
    ...
    // allSectionDiv.appendChild(navbarHeader,navDiv);
    // navBar.appendChild(allSectionDiv);
...
function createCardImageCol(result) {
    ...
    image.setAttribute('alt', 'Artile Image');
